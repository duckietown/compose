    ...
    <div class="api-service-box-container" style="position:relative">
        ...
        <div class="api-service-section">
            ...
            <div>
                ...
                <p>
                    ...
                    <span class="param emph">base_url</span>,
                ...
                <div class="api-service-subsection">
                    ...
                    <h4>
                        &bullet; <span class="param emph">base_url</span>:
                    </h4>
                    <div>
                        <p>
        ...
        <div class="api-service-section">
            ...
            <div>
                ...
                <p>
                    When <span class="param emph">format</span>=<span class="param emph">json</span>:
                </p>
                <div class="mono api-url-container">
                    <p>
                        {<br/>
                ...
                <br>
                <p>
                    When <span class="param emph">format</span>=<span class="param emph">xml</span>:
                </p>
                <div class="mono api-url-container">
                    <p>
